...
def draw_border(surface: pygame.Surface, bounds: pygame.Rect, border_color: pygame.Color, width=1, depth="up", inner=False):
    """
    ...
    # top border
    pygame.draw.polygon(surface, lighter_color, [
        outer_ring.topleft,
        outer_ring.topright,
        inner_ring.topright,
        inner_ring.topleft
